def setup_toolbar(qt_obj):
    tools = {}
    names = ['Upload photos', 'Upload Labels', 'Save', 'Upload Photo Folder', 'Upload video', 'Edit Mode',
             'Delete Selection(s)', 'Reset', 'Settings', 'Help']
    icons = ['upload_photo6.png', 'labels.png', 'save3.png', 'upload_folder5.png', 'upload_vid3.png',
             'draw_rectangle3.png', 'delete.png', 'reset4.png', 'settings.png', 'help.png']
    methods = [qt_obj.upload_photos, qt_obj.upload_labels, qt_obj.save_changes, qt_obj.upload_folder,
               qt_obj.upload_vid, qt_obj.edit_mode, qt_obj.delete_selections, qt_obj.reset_labels,
               qt_obj.display_settings, qt_obj.display_help]
    keys = 'OLSFVRDJAH'
    tips = ['Select photos from a folder and add them to the photo list',
            'Upload labels from .csv, .h5, .sqlite',
    ...
    check_status = [False, False, False, False, False, False, True, False, False, False, False]
